...
def test_extract_cards():
    ...
    valid_data = {
        "cards": {"cardCollectionRenderer": {"cards": [
            {"cardRenderer": {"startCardActiveMs": "1000", "teaser": {"simpleCardTeaserRenderer": {"message": {"simpleText": "Check this out"}}}}}
        ]}}
    }
    ...
    valid_data = {
        "contents": {"twoColumnWatchNextResults": {"results": {"results": {"contents": [
            ...
            {"videoSecondaryInfoRenderer": {"owner": {"videoOwnerRenderer": {"badges": [
                {"metadataBadgeRenderer": {"accessibilityData": {"label": "Verified"}, "style": "BADGE_STYLE_TYPE_VERIFIED", "icon": {"iconType": "CHECK_CIRCLE_THICK"}}}
            ]}}}}
        ]}}}}
    }
