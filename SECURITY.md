...
If you find a security vulnerability in who-will-viral, please report it through [GitHub's private vulnerability reporting](https://github.com/zizoisprogramming/who_will_viral/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact audreyfeldroy@example.com for details.
